...
INSERT INTO help_requests
  (id, request_no, title, requester_user_id, requester_name, helper_user_id, helper_name, content, requester_ip, request_datetime, request_date, status, created_at, updated_at)
VALUES
  (1, 'HLP202603250001', '权限开通申请未生效', 5, '王欣怡', 2, '陈志远', '市场部同事已提交权限开通申请，但系统中仍无法查看对应菜单，请协助核查。', '10.20.18.11', '2026-03-25 09:20:00', '2026-03-25', 'pending', '2026-03-25 09:20:00', '2026-03-25 09:20:00'),
  (2, 'HLP202603250002', '项目清单导出失败', 6, '张文博', 2, '陈志远', '在导出项目清单时页面提示处理失败，多次重试结果一致，请尽快处理。', '10.20.18.35', '2026-03-25 10:10:00', '2026-03-25', 'processing', '2026-03-25 10:10:00', '2026-03-25 10:25:00'),
  (3, 'HLP202603250003', '日报审批记录缺失', 7, '刘若晴', 3, '林书宁', '昨日提交的日报已审批，但今天无法查询到审批记录，请确认数据是否同步。', '10.20.18.52', '2026-03-25 11:00:00', '2026-03-25', 'waiting_confirm', '2026-03-25 11:00:00', '2026-03-25 11:30:00'),
  (4, 'HLP202603250004', '登录验证码未发送', 8, '何嘉辰', 4, '周明启', '外部网络访问登录页时验证码短信未收到，影响正常登录，请排查短信通道。', '10.20.18.77', '2026-03-25 13:40:00', '2026-03-25', 'completed', '2026-03-25 13:40:00', '2026-03-25 15:10:00'),
  (5, 'HLP202603250005', '合同附件无法预览', 5, '王欣怡', 3, '林书宁', '合同管理页可以上传附件，但点击预览时一直转圈没有内容返回。', '10.20.18.11', '2026-03-25 16:20:00', '2026-03-25', 'pending', '2026-03-25 16:20:00', '2026-03-25 16:20:00');
...
VALUES
  (2, 'help_request_created', '收到新的求助单', '求助单 HLP202603250001 已提交，请及时处理。', 1, 0, '2026-03-25 09:20:00'),
  (2, 'help_request_created', '收到新的求助单', '求助单 HLP202603250002 已提交，请及时处理。', 2, 1, '2026-03-25 10:10:00'),
  (3, 'help_request_created', '收到新的求助单', '求助单 HLP202603250003 已提交，请及时处理。', 3, 0, '2026-03-25 11:00:00'),
  (4, 'help_request_created', '收到新的求助单', '求助单 HLP202603250004 已提交，请及时处理。', 4, 1, '2026-03-25 13:40:00'),
  (3, 'help_request_created', '收到新的求助单', '求助单 HLP202603250005 已提交，请及时处理。', 5, 0, '2026-03-25 16:20:00');
